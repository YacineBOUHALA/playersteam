 ...
 */
final class Version20221220101312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE national_team (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, drapeau VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
